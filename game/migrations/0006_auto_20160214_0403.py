    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dockerfile', models.FileField(upload_to='docker/dockerfiles', verbose_name='compile dockerfile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('tag', models.CharField(max_length=50, verbose_name='tag')),
                ('compiled_code', models.FileField(upload_to='server/compiled_code', verbose_name='compiled code')),
        ...
        migrations.AddField(
            ...
            name='composer',
            field=models.FileField(upload_to='docker/composers', null=True, verbose_name='docker composer', blank=True),
        ),
        migrations.AddField(
            model_name='competition',
