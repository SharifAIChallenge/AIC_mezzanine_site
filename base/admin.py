...
class SubmitAdmin(admin.ModelAdmin):
    fieldsets = ((None, {"fields": ("status", "code", "compile_log_file", "compiled_code", "team","token","run_id","compiled_id")}),)
    list_display = ("get_team_name", "lang", "code", "status", "compile_log_file", "compiled_code","token","run_id","compiled_id")
    list_display_links = ()
    list_editable = ()
    list_filter = ("status",)
    search_fields = ()
